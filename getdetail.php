...
<div style="background-image: url('img6.jpg');">
    ...
    <table class="table table-dark table-striped">
		...
		<tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="neel">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="nehal">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="preeti">View</button>
				</form>
			</td>
        </tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="rijul">View</button>
				</form>
			</td>
		</tr>
		</tbody>
