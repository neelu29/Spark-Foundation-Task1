...
$name1=$_POST['sender'];
$q="select amount from view where name='$name1'";
$result=mysqli_query($con,$q);
$row=mysqli_fetch_array($result);
$var=$row['amount'];
$from=$_POST['sender'];
$to=$_POST['receiver'];
$q1="select amount from view where name='$to'";
...
if ( $var >= $_POST["transfer"] )
{
    ...
    $q="update view set amount='$sub' where name='$from' ";
    $result=mysqli_query($con,$q);
    $sum=$var1+$_POST["transfer"];
    $q="update view set amount='$sum' where name='$to' ";
    $result=mysqli_query($con,$q);
	$c=$_POST["transfer"];
